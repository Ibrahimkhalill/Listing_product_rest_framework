...
class Broker(models.Model):
  ...
  photo = models.ImageField(upload_to='media/broker',null=True, blank=True)
  active = models.BooleanField()

class Company(models.Model):
  id_admin = models.IntegerField(blank=True,null=True)
  comp_Name = models.CharField(max_length=200)
  comp_Logo = models.ImageField(upload_to='media/logo', null=True, blank=True)
...
class Properties(models.Model):
  id_broker = models.ForeignKey(Broker,on_delete=models.CASCADE)
